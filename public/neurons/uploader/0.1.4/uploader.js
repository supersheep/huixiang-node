...
var _5 = "uploader@0.1.4/src/adapter/flash.js";
var _6 = "uploader@0.1.4/src/adapter/ajax.js";
var _7 = "uploader@0.1.4/src/queue.js";
var _8 = "uploader@0.1.4/src/errors.js";
var _9 = "uploader@0.1.4/src/theme/default.js";
var _10 = "swfupload@~0.1.0";
var _11 = "json@~1.0.1";
var _12 = "uploader@0.1.4/src/adapter/flash_default_options.js";
var _13 = "simple-mime@^0.0.8";
var _14 = "uploader@0.1.4/src/uid.js";
...
Uploader.prototype._getType = function(){
    ...
    main:true,
    map:mix({"./adapter/flash":_5,"./adapter/ajax":_6,"./queue":_7,"./errors":_8,"./theme/default":_9},globalMap)
});

define(_5, [_2,_10,_0,_3,_1,_11,_8,_12], function(require, exports, module, __filename, __dirname) {
var $ = require("jquery");
...
FlashUploader._renderButton = function(elem){
    ...
    map:mix({"../errors":_8,"./flash_default_options":_12},globalMap)
});

define(_6, [_2,_1,_0,_4,_3,_13,_8], function(require, exports, module, __filename, __dirname) {
var EMPTY = '';
var $ = require('jquery');
var util = require('util');
var events = require('events');
...
attributes.patch(AjaxUploader, {
  ...
  isDisabled:{
    ...
    map:mix({"../errors":_8},globalMap)
});

define(_7, [_0,_1,_4,_3,_14], function(require, exports, module, __filename, __dirname) {
var events = require("events");
var util = require("util");
var attributes = require("attributes");
var uid = require("./uid");
