...
var _6 = "jquery@^1.9.1";
var _7 = "huixiang@0.1.0/mod/login.js";
...
$(".piece").each(function(i,e){
    ...
    entries:entries,
    map:mix({"../mod/login":_7},globalMap)
});

define(_7, [_8], function(require, exports, module, __filename, __dirname) {
