...
var _6 = "jquery@^1.9.1";
var _7 = "huixiang@0.1.0/mod/piece.js";
var entries = [_0,_1,_2,_3,_4,_5];
var asyncDepsToMix = {};
var globalMap = asyncDepsToMix;
define(_2, [_6,_7], function(require, exports, module, __filename, __dirname) {
var $ = require('jquery');
...
$(document).on("keyup",function(e){
    ...
    entries:entries,
    map:mix({"../mod/piece":_7},globalMap)
});
...
Piece.prototype = {
    ...
    fetch:function(cb){
        var self = this;
        $.getJSON("/api/pieces",function(json){
